...
introduce -- identifying scenarios that help us infer a trait, train a predictive model based on users for whom we observe the scenario, and then predict the trait for all users -- could, in principle, be used for other behavioural
traits, too.
